...
lib.ssMetadata = [
		{name:"PR_Yoga_AIO_i_27_CM_GDN_300x250_atlas_1", frames: [[604,0,50,50],[0,0,300,250],[0,252,300,250],[0,504,300,250],[0,756,300,250],[302,0,300,250],[302,252,300,250],[302,504,300,250],[302,756,300,250]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_Yoga_AIO_i_27_CM_GDN_300x250_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRYogaAIOi27CMGDN300x250 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(350).to({_off:false},0).wait(40));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(300).to({_off:false},0).to({_off:true},50).wait(40));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(250).to({_off:false},0).to({_off:true},50).wait(90));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(200).to({_off:false},0).to({_off:true},50).wait(140));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(150).to({_off:false},0).to({_off:true},50).wait(190));
...
// library properties:
lib.properties = {
	id: '37EAC7CFE2FA0C4497033399AEC47841',
	width: 300,
	height: 250,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_Yoga_AIO_i_27_CM_GDN_300x250_atlas_1.png", id:"PR_Yoga_AIO_i_27_CM_GDN_300x250_atlas_1"}
	],
	preloads: []
};
...
an.compositions['37EAC7CFE2FA0C4497033399AEC47841'] = {
